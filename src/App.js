        ...
        <div className='uk-width-1-3@m uk-margin uk-margin-medium-right profile-scroll'>
          ...
          <div className="uk-card uk-text-left uk-animation-slide-top uk-margin-top">
            <div className='uk-card uk-padding-small profile-border-rounded profile-card profile-font'>
              ...
              <div className="uk-child-width-expand@s uk-text-center" data-uk-grid>
                <div className='uk-width-1-3@m'>
                  <div className="uk-card uk-text-left">ReactJS</div>
                </div>
      ...
      <div className='uk-container uk-section uk-hidden@s'>
        ...
        <div className='uk-width-1-3@m uk-margin uk-margin-medium-right'>
          <div className="uk-grid-collapse uk-child-width-expand@s uk-text-center uk-margin-large-top borderRounded card-background uk-animation-slide-top" data-uk-grid>
            ...
            <div>
              <div className="uk-padding-small uk-flex uk-flex-center">
                <div className="uk-text-left uk-width-1-3 card-title">Free Code Camp</div>
                <div className="uk-margin-left uk-width-1-1">
                  <ul className='uk-list uk-text-left'>
                    <li><a href="https://www.freecodecamp.org/certification/eugene.pokalyuk/responsive-web-design">Responsive Web Design</a></li>
                    <li><a href="https://www.freecodecamp.org/certification/eugene.pokalyuk/javascript-algorithms-and-data-structures">JavaScript Algorithms and Data Structures</a></li>
                  </ul>
                </div>
              </div>
              <hr className='uk-align-center uk-margin-remove-top' style={width90} />
            ...
            <div>
              <div className="uk-padding-small uk-flex uk-flex-center">
                <div className="uk-text-left uk-width-1-3 card-title">HTML Academy</div>
                <div className="uk-margin-left uk-width-1-1">
                  <ul className='uk-list uk-text-left'>
                    <li><a href="https://htmlacademy.ru/profile/id137373">«Старт во фронтенде»</a></li>
                    <li><a href="https://htmlacademy.ru/profile/id137373">«Погружение в вёрстку»</a></li>
                    <li><a href="https://htmlacademy.ru/profile/id137373">«Погружение в JavaScript»</a></li>
                    <li><a href="https://htmlacademy.ru/profile/id137373">«Продвинутые техники и инструменты вёрстки»</a></li>
                    <li><a href="https://htmlacademy.ru/profile/id137373">«Знакомство с бэкендом»</a></li>
                    <li><a href="https://htmlacademy.ru/profile/id137373">«Ретровёрстка»</a></li>
                  </ul>
                </div>
              </div>
              <hr className='uk-align-center uk-margin-remove-top' style={width90} />
            ...
            <div>
              <div className="uk-padding-small uk-flex uk-flex-center">
                <div className="uk-text-left uk-width-1-3 card-title">Skillbox</div>
                <div className="uk-margin-left uk-width-1-1">
                  <ul className='uk-list uk-text-left'>
                    <li><a href="#null">Веб-верстка «Базовый уровень», «Продвинутый уровень»</a></li>
                    <li><a href="#null">JavaScript «Базовый уровень», «Продвинутый уровень»</a></li>
                    <li><a href="#null">Node.js</a></li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="uk-grid-collapse uk-child-width-expand@s uk-text-center uk-margin-large-top borderRounded card-background uk-animation-slide-top" data-uk-grid>
            ...
            <div>
              <div className="uk-padding-small uk-flex uk-flex-center">
                <div className="uk-text-left uk-width-1-3 card-title">ReactJS</div>
                <div className="uk-margin-left uk-width-1-1">
                  <ul className='uk-list uk-text-left'>
                    <li><a href="https://eugenepokalyuk.github.io/todo-list/">To-Do List</a></li>
